...
export class SchemaService {
  ...
  public async init(): Promise<void> {
    ...
    this.#schema = await buildSchema({
      ...
      // We can do this safely thanks to some logic in the AccessControlAuthorized decorator which sets
      // any authorized fields as nullable
      authMode: "null",
      globalMiddlewares: [
    ...
    const schemaString = await format(
      printSchema(lexicographicSortSchema(this.#schema)),
      {
        parser: "graphql",
      }
    );
