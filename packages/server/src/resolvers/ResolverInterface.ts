...
import type { AbstractGraphQLArrayOkResponse, AbstractGraphQLCreatedResponse, AbstractGraphQLOkResponse, AbstractGraphQLPaginatedResponse } from "./ApiResponse.js";
...
export interface ResolverInterface<R extends Resource> {
  ...
  list?: <Q extends UnfilteredListQueryArgs>(query: Q) => Promise<AbstractGraphQLPaginatedResponse<R>>;
