...
export type DbFundsEntryViewerQuery = { __typename?: 'Query', rawFundraisingEntries: string };
...
export type DbFundsViewerQuery = { __typename?: 'Query', rawFundraisingTotals: string };
