...
export const DBMomentsScreen = () => {
  ...
  let flashComponent = (
    <Fab renderInPortal={false} style={{height: 40, width: 40, backgroundColor: 'rgba(0, 0, 0, 0.2)' }} top={5+65} right={2} icon={<Icon color="white" as={<MaterialIcons name="flash-off"/>} size={7} />} onPress={toggleFlash}/>
  );
  ...
  function toggleFlash() {
    if (flash === FlashMode.on) {
      ...
      flashComponent = (
        <Fab renderInPortal={false} style={{height: 40, width: 40, backgroundColor: 'rgba(0, 0, 0, 0.2)' }} top={5+65} right={2} icon={<Icon color="white" as={<MaterialIcons name="flash-on"/>} size={7} />} onPress={toggleFlash}/>
      );
  ...
  return (
    <View style={{flex: 1, justifyContent: "center"}}>
      ...
      <Camera style={{flex: 1}} type={cameraType} ref={cameraRef} onCameraReady={onCameraReady} flashMode={flash}>
        <Box style={{flex: 1}}>
          <Fab renderInPortal={false} style={{height: 40, width: 40, backgroundColor: 'rgba(0, 0, 0, 0.2)' }} top={5} right={2} icon={<Icon color="white" as={<MaterialIcons name="cameraswitch"/>} size={7} />} onPress={toggleCameraType}/>
          {flashComponent}
          <Fab renderInPortal={false} style={{height: 40, width: 40, backgroundColor: 'rgba(0, 0, 0, 0.2)' }} top={65+50+5} right={2} icon={<Icon color="white" as={<MaterialIcons name="info"/>} size={7} />} onPress={toggleCameraType}/>
          <Fab renderInPortal={false} style={{height: 50, width: 50, backgroundColor: 'rgba(0, 0, 0, 0.2)'  }} bottom={5} right={2} icon={<Icon color="white" as={<MaterialCommunityIcons name="circle-slice-8"/>} size={10} />} onPress={takePicture}/>
          <Fab renderInPortal={false} style={{height: 50, width: 50, backgroundColor: 'rgba(0, 0, 0, 0.2)' }} bottom={5} left={2} icon={<Icon color="white" as={<MaterialCommunityIcons name="dots-circle"/>} size={10} />} onPress={toggleCameraType}/>
        </Box>
      </Camera>
    )}
    </View>
